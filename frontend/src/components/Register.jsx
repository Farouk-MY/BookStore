// AuthValidation.js - Shared validation logic
        ...
        <div className="w-full sm:w-1/2 px-8 py-12">
          <div className="max-w-md mx-auto">
            ...
            <p className="mt-8 text-center text-gray-500 text-sm">
              ...
              <a href="#" className="text-yellow-600 hover:underline">Terms</a> and{' '}
        ...
        <div className="hidden sm:block w-1/2 relative bg-gradient-to-br from-yellow-500 to-purple-600">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="text-white text-center">
              <h3 className="text-4xl font-bold mb-4">Welcome to BeeStore</h3>
              <p className="text-lg">Your gateway to endless stories and knowledge</p>
            </div>
          </div>
        </div>
      </motion.div>
